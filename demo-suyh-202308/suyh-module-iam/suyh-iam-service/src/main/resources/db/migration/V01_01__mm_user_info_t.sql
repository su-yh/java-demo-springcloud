...
ALTER TABLE mm_user_info_t ADD UNIQUE INDEX index_phone(phone) USING BTREE;
ALTER TABLE mm_user_info_t ADD UNIQUE INDEX index_email(email) USING BTREE;
